...
public class CategoryButton {
    ...
    public void render(GuiGraphicsExtractor graphics, int mouseX, int mouseY) {
        ...
        int bgColor = this.selected ? -39373 : FastClientUI.blend(-435153640, -266722777, this.hoverProgress);
        ...
        int textColor = this.selected ? -723724 : FastClientUI.blend(-7303024, -723724, this.hoverProgress);
