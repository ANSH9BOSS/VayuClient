...
extends UIComponent {
    ...
    public void render(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float delta) {
        ...
        if (this.listening) {
            ...
            graphics.fill(btnX - 2, btnY - 2, btnX + btnWidth + 2, btnY, FastClientUI.withAlpha(-39373, glowAlpha));
            graphics.fill(btnX - 2, btnY + btnHeight, btnX + btnWidth + 2, btnY + btnHeight + 2, FastClientUI.withAlpha(-39373, glowAlpha));
        }
        if (this.listening) {
            keyText = "Press Key...";
            textColor = -723724;
