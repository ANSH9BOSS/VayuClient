...
extends UIComponent {
    ...
    public void render(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float delta) {
        ...
        int valueColor = this.dragging ? -39373 : -7303024;
        ...
        FastClientUI.roundedRect(graphics, this.x + trackPadding, trackY, trackWidth, trackHeight, 3, -435153640);
        double percent = (this.value - this.min) / (this.max - this.min);
        int fillWidth = (int)((double)trackWidth * percent);
        FastClientUI.roundedRect(graphics, this.x + trackPadding, trackY, fillWidth, trackHeight, 3, -39373);
        ...
        int handleColor = this.dragging ? -34227 : -723724;
        FastClientUI.roundedRect(graphics, handleX - handleSize / 2, handleCenterY - handleSize / 2, handleSize, handleSize, handleSize / 2, handleColor);
