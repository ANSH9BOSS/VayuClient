...
public class CosmeticTextureCache {
    ...
    private final Path cacheDir = FabricLoader.getInstance().getConfigDir().resolve("vayuclient-hud-cosmetic-cache");
    ...
    public CosmeticTextureCache() {
        try {
            ...
            VayuHUDClient.LOGGER.warn("[TextureCache] Failed to create cache dir: {}", (Object)e.getMessage());
        }
    }
                    ...
                    try {
                        ...
                        if (response.statusCode() == 200) {
                            try (InputStream in = response.body();){
                                ...
                                VayuHUDClient.LOGGER.info("[TextureCache] Cached {} ({} bytes)", (Object)cosmeticId, (Object)data.length);
                        ...
                        VayuHUDClient.LOGGER.warn("[TextureCache] Failed to fetch {}: {}", (Object)cosmeticId, (Object)e.getMessage());
                        future.complete(null);
                    }
                    finally {
