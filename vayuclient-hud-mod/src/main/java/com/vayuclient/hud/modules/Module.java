 ...
 */
package com.vayuclient.hud.modules;
...
public abstract class Module {
    ...
    protected void sendMessage(String message) {
        if (Module.mc.player != null) {
            Module.mc.player.sendSystemMessage((Component)Component.literal((String)("\u00a77[\u00a7bVayuHUD\u00a77] \u00a7f" + message)));
        }
    }
    ...
    private static String readableName(String name) {
        return switch (name) {
            ...
            case "NametagIcon" -> "VayuClient Nametag";
