 ...
 */
package com.vayuclient.hud.core;
...
import com.vayuclient.hud.modules.impl.hud.ArmorHUD;
import com.vayuclient.hud.modules.impl.hud.ArrayListModule;
import com.vayuclient.hud.modules.impl.hud.BiomeHUD;
import com.vayuclient.hud.modules.impl.hud.CPSCounter;
import com.vayuclient.hud.modules.impl.hud.ChatTimestamps;
import com.vayuclient.hud.modules.impl.hud.ComboCounter;
import com.vayuclient.hud.modules.impl.hud.CoordinatesModule;
import com.vayuclient.hud.modules.impl.hud.DirectionHUD;
import com.vayuclient.hud.modules.impl.hud.FPSModule;
import com.vayuclient.hud.modules.impl.hud.Keystrokes;
import com.vayuclient.hud.modules.impl.hud.PackDisplay;
import com.vayuclient.hud.modules.impl.hud.PingDisplay;
import com.vayuclient.hud.modules.impl.hud.PotionHUD;
import com.vayuclient.hud.modules.impl.hud.ServerInfoHUD;
import com.vayuclient.hud.modules.impl.hud.SpeedHUD;
import com.vayuclient.hud.modules.impl.movement.SprintModule;
import com.vayuclient.hud.modules.impl.player.ToggleSneak;
...
import com.vayuclient.hud.modules.impl.render.NoBossBar;
import com.vayuclient.hud.modules.impl.render.NoHurtCam;
import com.vayuclient.hud.modules.impl.render.Particles;
import com.vayuclient.hud.modules.impl.render.PerformanceModule;
import com.vayuclient.hud.modules.impl.render.PingOverlay;
import com.vayuclient.hud.modules.impl.render.ScoreboardMod;
import com.vayuclient.hud.modules.impl.render.TimeChanger;
import com.vayuclient.hud.modules.impl.render.WaypointsModule;
import com.vayuclient.hud.modules.impl.utility.AutoGG;
import com.vayuclient.hud.modules.impl.utility.AutoText;
import com.vayuclient.hud.modules.impl.utility.Notifications;
import com.vayuclient.hud.modules.impl.utility.ToolWarning;
import com.vayuclient.hud.modules.impl.utility.ZoomModule;
import com.vayuclient.hud.modules.impl.hud.PotionAlert;
import com.vayuclient.hud.modules.impl.hud.InputLagMeter;
import com.vayuclient.hud.modules.impl.hud.StutterDetector;
import com.vayuclient.hud.modules.impl.hud.PingGraph;
import com.vayuclient.hud.modules.impl.hud.ArmorWarning;
import com.vayuclient.hud.modules.impl.hud.BentoHUD;
import com.vayuclient.hud.modules.impl.render.DynamicFPSBoost;
import com.vayuclient.hud.modules.impl.render.FlickBlur;
import com.vayuclient.hud.modules.impl.render.CustomGlint;
...
public class ModuleManager {
    ...
    private volatile Module[] activeRenderModules = new Module[0];
    ...
    public ModuleManager() {
        instance = this;
        this.configPath = FabricLoader.getInstance().getConfigDir().resolve("vayuclient-hud").resolve("modules.json");
    ...
    public void registerModules() {
        ...
        this.register(new PerformanceModule());
        ...
        this.register(new PotionAlert());
        this.register(new InputLagMeter());
        this.register(new StutterDetector());
        this.register(new DynamicFPSBoost());
        this.register(new PingGraph());
        this.register(new ArmorWarning());
        this.register(new FlickBlur());
        this.register(new CustomGlint());
        this.register(new BentoHUD());
        this.register(new ObjectOverrider());
        this.captureDefaults();
        LOGGER.info("[ModuleManager] {} modules registered", (Object)this.modules.size());
        this.loadConfig();
        this.rebuildActiveRenderModules();
    }

    public void onTick() {
        KeybindManager km = KeybindManager.getInstance();
        if (km != null) {
            km.handleKeybinds();
        }
    ...
    public void rebuildActiveRenderModules() {
        List<Module> active = new ArrayList<Module>();
        for (Module m : this.modules) {
            if (m.isEnabled() && (m.getCategory() == Category.HUD || m.getCategory() == Category.RENDER || m.getCategory() == Category.UTILITY)) {
                active.add(m);
            }
        }
        this.activeRenderModules = active.toArray(new Module[0]);
    }

    public Module[] getActiveRenderModules() {
        return this.activeRenderModules;
    }
    ...
    public void applyHudPreset(String presetId) {
        ...
        switch (presetId) {
            ...
            case "performance": {
                ...
                this.enable("PingDisplay", left, top + 40, 1.35f);
