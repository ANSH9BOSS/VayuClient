...
import com.vayuclient.hud.gui.screens.HudOverlayScreen;
import com.vayuclient.hud.gui.screens.WaypointsScreen;
...
public class KeybindManager {
    ...
    public void init() {
        this.zoomKey = KeyMappingHelper.registerKeyMapping((KeyMapping)new KeyMapping("key.vayuclient-hud.zoom", InputConstants.Type.KEYSYM, -1, KeyMapping.Category.MISC));
        this.fpsToggleKey = KeyMappingHelper.registerKeyMapping((KeyMapping)new KeyMapping("key.vayuclient-hud.fps_toggle", InputConstants.Type.KEYSYM, 295, KeyMapping.Category.MISC));
        this.fullbrightToggleKey = KeyMappingHelper.registerKeyMapping((KeyMapping)new KeyMapping("key.vayuclient-hud.fullbright_toggle", InputConstants.Type.KEYSYM, 296, KeyMapping.Category.MISC));
        this.clickGuiKey = KeyMappingHelper.registerKeyMapping((KeyMapping)new KeyMapping("key.vayuclient-hud.click_gui", InputConstants.Type.KEYSYM, 344, KeyMapping.Category.MISC));
