...
public final class LauncherTheme {
    ...
    public static final int STORE_GRADIENT_TOP = -16723201; // 0xFF00D2FF (Vayu Cyan)
    public static final int STORE_GRADIENT_BOT = -16612153; // 0xFF0284C7 (Vayu Royal Blue)
