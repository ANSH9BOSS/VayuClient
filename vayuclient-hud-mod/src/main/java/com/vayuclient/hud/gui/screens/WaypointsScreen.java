...
extends Screen {
    ...
    public WaypointsScreen(Screen parent) {
        super((Component)Component.literal((String)"Waypoints"));
        com.vayuclient.hud.core.ModuleManager mm = com.vayuclient.hud.core.ModuleManager.getInstance();
        this.module = mm != null ? mm.getModule(WaypointsModule.class) : null;
    }
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float delta) {
        ...
        VayuHUDUI.roundedRect(graphics, this.panelX, this.panelY, this.panelWidth, this.panelHeight, 7, -234156528);
        VayuHUDUI.outline(graphics, this.panelX, this.panelY, this.panelWidth, this.panelHeight, 1143616571);
        graphics.fill(this.panelX, this.panelY, this.panelX + this.panelWidth, this.panelY + 3, -16723201);
    ...
    private void renderList(GuiGraphicsExtractor graphics, int mouseX, int mouseY) {
        ...
        if (waypoints.isEmpty()) {
            VayuHUDUI.roundedRect(graphics, this.listX, listTop, this.listWidth, 70, 5, -653586413);
        ...
        for (int i = 0; i < waypoints.size(); ++i) {
            ...
            VayuHUDUI.roundedRect(graphics, this.listX, rowY, this.listWidth, 52, 5, waypoint.enabled ? -653586413 : -435219433);
            VayuHUDUI.outline(graphics, this.listX, rowY, this.listWidth, 52, this.selectedId != null && this.selectedId.equals(waypoint.id) ? -16723201 : 1143616571);
    ...
    private void drawButton(GuiGraphicsExtractor graphics, int x, int y, int width, int height, String label, int mouseX, int mouseY, boolean accent) {
        ...
        int background = accent ? (hovered ? -13058312 : -16723201) : (hovered ? -266722777 : -435153640);
        VayuHUDUI.roundedRect(graphics, x, y, width, height, 4, background);
        VayuHUDUI.outline(graphics, x, y, width, height, hovered ? -16723201 : 1143616571);
