...
public final class VayuFonts {
    private static final Typeface ACTIVE_TYPEFACE = Typeface.INTER;
    private static final float FIXED_MINECRAFT_UI_SCALE = 1.0f;
    private static final FontDescription.Resource INTER_SEMIBOLD = new FontDescription.Resource(Identifier.fromNamespaceAndPath((String)"vayuclient-hud", (String)"inter-semibold"));
    private static final FontDescription.Resource INTER_BOLD = new FontDescription.Resource(Identifier.fromNamespaceAndPath((String)"vayuclient-hud", (String)"inter-bold"));
    private static final FontDescription.Resource INTER_BOLD_14 = new FontDescription.Resource(Identifier.fromNamespaceAndPath((String)"vayuclient-hud", (String)"inter-bold-14"));
    ...
    private static final FontDescription.Resource MATERIAL_SYMBOLS_ROUNDED = new FontDescription.Resource(Identifier.fromNamespaceAndPath((String)"vayuclient-hud", (String)"material-symbols-rounded"));
    private static final FontDescription.Resource MATERIAL_SYMBOLS_ROUNDED_FILLED = new FontDescription.Resource(Identifier.fromNamespaceAndPath((String)"vayuclient-hud", (String)"material-symbols-rounded-filled"));

    private VayuFonts() {
    }

    public static Component body(String text) {
        return VayuFonts.styled(text, TextRole.BODY);
    }

    public static Component strong(String text) {
        return VayuFonts.styled(text, TextRole.STRONG);
    }

    public static Component title(String text) {
        return VayuFonts.styled(text, TextRole.TITLE);
    }

    public static Component moduleName(String text) {
        return VayuFonts.body(text);
    }
    ...
    public static float bodyScale() {
        return VayuFonts.configuredUiScale();
    }
    ...
    public static Component materialSymbolLabel(String symbol, String label) {
        return Component.empty().append(VayuFonts.materialSymbol(symbol)).append((Component)Component.literal((String)(" " + label)));
    }

    public static Component filledMaterialSymbolLabel(String symbol, String label) {
        return Component.empty().append(VayuFonts.filledMaterialSymbol(symbol)).append((Component)Component.literal((String)(" " + label)));
    }
